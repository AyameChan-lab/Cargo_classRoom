...
use crate::{
    ...
    infrastructure::{
        database::{
            ...
            repositories::{
                mission_operation::MisssionOperationPostgres,
...
pub fn routes(db_pool: Arc<PgPoolSquad>) -> Router {
    let mission_operation_repository = MisssionOperationPostgres::new(Arc::clone(&db_pool));
    let mission_viewing_repository = MisssionViewingPostgres::new(Arc::clone(&db_pool));
